    ...
    methods: {
      async getPedidos() {
        const req = await fetch(
          'http://localhost:3000/box_e09a37a9fbc4972b9488/burgers',
        );
      ...
      async getStatus() {
        const req = await fetch(
          'http://localhost:3000/box_e09a37a9fbc4972b9488/status',
        );
      ...
      async deleteBurger(_id) {
        const req = await fetch(
          `http://localhost:3000/box_e09a37a9fbc4972b9488/${_id}`,
          {
            method: 'DELETE',
          },
        );
      ...
      async updatedBurger(event, nome) {
        ...
        const take = await fetch(
          `http://localhost:3000/box_e09a37a9fbc4972b9488?q=nome:${nome}`,
          {
            method: 'GET',
          },
        );
        ...
        const req = await fetch(
          `http://localhost:3000/box_e09a37a9fbc4972b9488/${burger[0]._id}`,
          {
            method: 'PUT',
